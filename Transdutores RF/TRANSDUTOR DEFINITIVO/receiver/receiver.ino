...
void loop() {
  ...
  char _radioData[2];  // Buffer para armazenar a direção recebida


  // Compara a direção recebida e executa a ação correspondente
  if (strcmp(_radioData, "1") == 0) {
    Serial.println("Moving forward");
    moveForward();
  } else if (strcmp(_radioData, "2") == 0) {
    Serial.println("Moving backward");
    moveBackward();
  } else if (strcmp(_radioData, "3") == 0) {
    Serial.println("Turning right");
    turnRight();
  } else if (strcmp(_radioData, "4") == 0) {
